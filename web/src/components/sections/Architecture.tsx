...
export function Architecture({ content }: { content: PortfolioContent }) {
  ...
  return (
    <section id="architecture" className="relative py-8 sm:py-12" aria-label="Arquitectura">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mt-3 text-base text-[#a9a8b8]">{architecture.description}</p>
          {architecture.note && (
            <p className="mt-4 border-l-2 border-[#8b5cf6]/60 pl-4 text-sm leading-relaxed text-[#a9a8b8]">
              {architecture.note}
            </p>
          )}
        </motion.div>
